...
SDK.DOMAIN = "mmbots.mercurialminds.com";
SDK.NAME = "mercurialminds";
SDK.APP = "";

//SDK.DOMAIN = window.location.host;
//SDK.APP = "/mercurialminds";
 ...
 * @static
 */
SDK.applicationId = 9019207319408843864;
...
SDK.translators = {
	"pt" : {
		...
		"Enter valid email" : "Digite e-mail vÃ¡lido",
		"Ping server" : "Servidor Ping",
		"Flag user" : "Flag user",
		"Whisper user" : "UsuÃ¡rio Whisper",
		...
		"Would you like a copy of the chat log sent to your email?" : "Gostaria de uma cÃ³pia do registro de bate-papo enviado para o seu e-mail?"
	},
	"fr" : {
		"Yes" : "Oui",
		"No" : "Non",
		...
		"Request private" : "Demander privÃ©",
		"Clear log" : "Effacer le journal",
		"Accept private" : "Accepter privÃ©",
		"Send image" : "Envoyer une image",
		"Send file" : "Envoyer le fichier",
		"Email Chat Log" : "Journal de messagerie Ã©lectronique",
		"Chime" : "Carillon",
		"Exit chat" : "Quitter le chat",
		"Text to speech" : "Texte pour parler",
		"Speech recognition" : "Reconnaissance vocale",
		"Speech Recognition" : "Reconnaissance vocale",
		"Quit private channel" : "Quitter la chaÃ®ne privÃ©e",
		"Quit private or channel" : "Quitter privÃ© ou canal",
		"Would you like a copy of the chat log sent to your email?" : "Souhaitez-vous recevoir une copie du journal de chat envoyÃ© Ã  votre adresse e-mail?"
	},
	"es" : {
		"Yes" : "SÃ­",
		"No" : "No",
		...
		"Enter valid email" : "Ingrese un correo electrÃ³nico vÃ¡lido",
		"Ping server" : "Servidor Ping",
		...
		"Email Chat Log" : "Registro de chat de correo electrÃ³nico",
		"Chime" : "Campaneo",
		...
		"Would you like a copy of the chat log sent to your email?" : "Desea enviar un mensaje a su direcciÃ³n de correo electrÃ³nico?"
	},
	"de" : {
		"Yes" : "Ja",
		"No" : "Nein",
		...
		"Choose Language" : "WÃ¤hle eine Sprache",
		"Enter valid email" : "Geben Sie gÃ¼ltige E-Mail-Adresse ein",
		"Ping server" : "Ping-Server",
		"Flag user" : "Benutzer kennzeichnen",
		"Whisper user" : "FlÃ¼stern Benutzer",
		"Request private" : "Privat anfragen",
		"Clear log" : "Protokoll lÃ¶schen",
		...
		"Would you like a copy of the chat log sent to your email?" : "MÃ¶chten Sie eine Kopie des Chat-Protokolls an Ihre E-Mail-Adresse senden?"
	},
	"zh" : {
		"Yes" : "æ˜¯",
		"No" : "æ²’æœ‰",
		...
		"Enter name" : "è¼¸å…¥åå­—",
		"Chat Log" : "èŠå¤©è¨˜éŒ„",
		"Choose Language" : "é¸æ“‡èªžè¨€",
		"Enter valid email" : "è¼¸å…¥æœ‰æ•ˆçš„éƒµä»¶",
		"Ping server" : "å®å™¹æœå‹™å™¨",
		"Flag user" : "æ¨™è¨˜ç”¨æˆ¶",
		"Whisper user" : "è€³èªžç”¨æˆ¶",
		"Request private" : "è«‹æ±‚ç§äºº",
		"Clear log" : "æ¸…é™¤æ—¥èªŒ",
		"Accept private" : "æŽ¥å—ç§äºº",
		"Send image" : "ç™¼é€åœ–åƒ",
		"Send file" : "ç™¼é€æ–‡ä»¶",
		"Email Chat Log" : "é›»å­éƒµä»¶èŠå¤©æ—¥èªŒ",
		"Chime" : "é˜",
		"Exit chat" : "é€€å‡ºèŠå¤©",
		"Text to speech" : "æ–‡å­—è½‰èªžéŸ³",
		"Speech recognition" : "èªžéŸ³è­˜åˆ¥",
		"Speech Recognition" : "èªžéŸ³è­˜åˆ¥",
		"Quit private channel" : "é€€å‡ºç§äººé »é“",
		"Quit private or channel" : "é€€å‡ºç§äººæˆ–é »é“",
		"Would you like a copy of the chat log sent to your email?" : "ä½ æƒ³è¦ç™¼é€åˆ°ä½ çš„é›»å­éƒµä»¶çš„èŠå¤©è¨˜éŒ„çš„å‰¯æœ¬å—Ž?"
	},
	"ja" : {
		"Yes" : "ã¯ã„",
		"No" : "ã„ã„ãˆ",
		...
		"Disconnect" : "åˆ‡æ–­ã™ã‚‹",
		"Speech" : "ã‚¹ãƒ”ãƒ¼ãƒ",
		"Enter name" : "åå‰ã‚’å…¥åŠ›",
		"Chat Log" : "ãƒãƒ£ãƒƒãƒˆãƒ­ã‚°",
		"Clear log" : "ãƒ­ã‚°ã‚’ã‚¯ãƒªã‚¢ã™ã‚‹",
		"Choose Language" : "è¨€èªžã‚’é¸æŠžã™ã‚‹",
		"Enter valid email" : "æœ‰åŠ¹ãªãƒ¡ãƒ¼ãƒ«ã‚¢ãƒ‰ãƒ¬ã‚¹ã‚’å…¥åŠ›",
		"Ping server" : "ãƒªãƒ³ã‚°ã‚µãƒ¼ãƒãƒ¼",
		"Flag user" : "ãƒ¦ãƒ¼ã‚¶ãƒ¼ã«ãƒ•ãƒ©ã‚°ã‚’è¨­å®šã™ã‚‹",
		"Whisper user" : "ã•ã•ã‚„ããƒ¦ãƒ¼ã‚¶ãƒ¼",
		"Request private" : "ãƒ—ãƒ©ã‚¤ãƒ™ãƒ¼ãƒˆã‚’ãƒªã‚¯ã‚¨ã‚¹ãƒˆã™ã‚‹",
		"Accept private" : "ãƒ—ãƒ©ã‚¤ãƒ™ãƒ¼ãƒˆã‚’å—ã‘å…¥ã‚Œã‚‹",
		"Send image" : "ç”»åƒã‚’é€ã‚‹",
		"Send file" : "ãƒ•ã‚¡ã‚¤ãƒ«ã‚’é€ä¿¡",
		"Upload image" : "ç”»åƒã‚’ã‚¢ãƒƒãƒ—ãƒ­ãƒ¼ãƒ‰ã™ã‚‹",
		"Upload file" : "ãƒ•ã‚¡ã‚¤ãƒ«ã‚’ã‚¢ãƒƒãƒ—ãƒ­ãƒ¼ãƒ‰ã™ã‚‹",
		"Email Chat Log" : "ãƒ¡ãƒ¼ãƒ«ãƒãƒ£ãƒƒãƒˆãƒ­ã‚°",
		"Chime" : "ãƒãƒ£ã‚¤ãƒ ",
		"Exit chat" : "ãƒãƒ£ãƒƒãƒˆã‚’çµ‚äº†",
		"Text to speech" : "ã‚¹ãƒ”ãƒ¼ãƒãƒ†ã‚­ã‚¹ãƒˆ",
		"Speech recognition" : "éŸ³å£°èªè­˜",
		"Speech Recognition" : "éŸ³å£°èªè­˜",
		"Quit private channel" : "ãƒ—ãƒ©ã‚¤ãƒ™ãƒ¼ãƒˆãƒãƒ£ãƒ³ãƒãƒ«ã‚’çµ‚äº†ã™ã‚‹",
		"Quit private or channel" : "ãƒ—ãƒ©ã‚¤ãƒ™ãƒ¼ãƒˆã¾ãŸã¯ãƒãƒ£ãƒ³ãƒãƒ«ã‚’çµ‚äº†ã™ã‚‹",
		"Would you like a copy of the chat log sent to your email?" : "ãƒãƒ£ãƒƒãƒˆãƒ­ã‚°ã®ã‚³ãƒ”ãƒ¼ã‚’ãƒ¡ãƒ¼ãƒ«ã«é€ä¿¡ã—ã¾ã™ã‹?"
	},
	"ar" : {
		"Yes" : "Ù†Ø¹Ù… ÙØ¹Ù„Ø§",
		"No" : "Ù„Ø§",
		...
		"Chat Log" : "Ø³Ø¬Ù„ Ø§Ù„Ø¯Ø±Ø¯Ø´Ø©",
		"Clear log" : "Ø³Ø¬Ù„ Ù†Ø¸ÙŠÙ",
		"Choose Language" : "Ø§Ø®ØªØ± Ø§Ù„Ù„ØºØ©",
		"Enter valid email" : "Ø£Ø¯Ø®Ù„ Ø¨Ø±ÙŠØ¯ Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ ØµØ§Ù„Ø­Ø§",
		"Ping server" : "Ø®Ø§Ø¯Ù… Ø¨ÙŠÙ†Øº",
		"Flag user" : "Ù…Ø³ØªØ®Ø¯Ù… Ø§Ù„Ø¹Ù„Ù…",
		"Whisper user" : "Ø§Ù„Ù‡Ù…Ø³ Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…",
		"Request private" : "Ø·Ù„Ø¨ Ø®Ø§Øµ",
		"Clear Log" : "Ø³Ø¬Ù„ Ù†Ø¸ÙŠÙ",
		"Accept private" : "Ù‚Ø¨ÙˆÙ„ Ø®Ø§Øµ",
		"Send image" : "Ø¥Ø±Ø³Ø§Ù„ ØµÙˆØ±Ø©",
		"Send file" : "Ø¥Ø±Ø³Ø§Ù„ Ù…Ù„Ù",
		"Email Chat Log" : "Ø³Ø¬Ù„ Ø§Ù„Ø¯Ø±Ø¯Ø´Ø© Ø¹Ø¨Ø± Ø§Ù„Ø¨Ø±ÙŠØ¯ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ",
		"Chime" : "Ù‚Ø±Ø¹ Ø§Ù„Ø£Ø¬Ø±Ø§Ø³",
		"Exit chat" : "Ø§Ù„Ø®Ø±ÙˆØ¬ Ù…Ù† Ø§Ù„Ø¯Ø±Ø¯Ø´Ø©",
		"Text to speech" : "Ø§Ù„Ù†Øµ Ø¥Ù„Ù‰ Ø§Ù„ÙƒÙ„Ø§Ù…",
		"Speech Recognition" : "Ø§Ù„ØªØ¹Ø±Ù Ø¹Ù„Ù‰ Ø§Ù„ÙƒÙ„Ø§Ù…",
		"Quit private channel" : "Ø¥Ù†Ù‡Ø§Ø¡ Ø§Ù„Ù‚Ù†Ø§Ø© Ø§Ù„Ø®Ø§ØµØ©",
		"Quit private or channel": "Ø¥Ù†Ù‡Ø§Ø¡ Ø®Ø§Øµ Ø£Ùˆ Ù‚Ù†Ø§Ø©",
		"Would you like a copy of the chat log sent to your email?" : "Ù‡Ù„ ØªØ±ÙŠØ¯ Ø¥Ø±Ø³Ø§Ù„ Ù†Ø³Ø®Ø© Ù…Ù† Ø³Ø¬Ù„ Ø§Ù„Ø¯Ø±Ø¯Ø´Ø© Ø¥Ù„Ù‰ Ø¨Ø±ÙŠØ¯Ùƒ Ø§Ù„Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠØŸ"
	},
	"ru" : {
		"Yes" : "Ð”Ð°",
		"No" : "HÐµÑ‚",
		...
		"Email": "Ð­Ð». Ð¿Ð¾Ñ‡Ñ‚Ð°",
		"Phone" : "Ð¢ÐµÐ»ÐµÑ„Ð¾Ð½",
		"Connect" : "CÐ¾ÐµÐ´Ð¸Ð½Ð¸Ñ‚ÑŒ",
		"Disconnect" : "ÐžÑ‚ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ",
		"Speech" : "PÐµÑ‡ÑŒ",
		"Enter name" : "Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ",
		"Chat Log" : "Ð–ÑƒÑ€Ð½Ð°Ð» Ñ‡Ð°Ñ‚Ð°",
		"Choose Language" : "Ð’Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ ÑÐ·Ñ‹Ðº",
		"Enter valid email" : "Ð’Ð²ÐµÐ´Ð¸Ñ‚Ðµ Ð´ÐµÐ¹ÑÑ‚Ð²ÑƒÑŽÑ‰Ð¸Ð¹ Ð°Ð´Ñ€ÐµÑ ÑÐ»ÐµÐºÑ‚Ñ€Ð¾Ð½Ð½Ð¾Ð¹ Ð¿Ð¾Ñ‡Ñ‚Ñ‹",
		"Ping server" : "ÐŸÐ¸Ð½Ð³ ÑÐµÑ€Ð²ÐµÑ€",
		"Flag user" : "OÑ‚Ð¼ÐµÑ‚Ð¸Ñ‚ÑŒ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ",
		"Whisper user" : "ÐŸÑ€Ð¾ÑˆÐµÐ¿Ñ‚Ð°Ñ‚ÑŒ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŽ",
		"Request private" : "Ð§Ð°ÑÑ‚Ð½Ñ‹Ð¹ Ð·Ð°Ð¿Ñ€Ð¾Ñ",
		"Clear log" : "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ð¶ÑƒÑ€Ð½Ð°Ð»",
		"Clear Log" : "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ Ð¶ÑƒÑ€Ð½Ð°Ð»",
		"Accept private" : "ÐŸÑ€Ð¸Ð½ÑÑ‚ÑŒ ÐºÐ¾Ð½Ñ„Ð¸Ð´ÐµÐ½Ñ†Ð¸Ð°Ð»ÑŒÐ½o",
		"Send image" : "ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ",
		"Send file" : "ÐžÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ Ñ„Ð°Ð¹Ð»",
		"Email Chat Log" : "OÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ Ð¶ÑƒÑ€Ð½Ð°Ð» Ñ‡Ð°Ñ‚Ð° Ð¿Ð¾ ÑÐ»ÐµÐºÑ‚Ñ€Ð¾Ð½Ð½Ð¾Ð¹ Ð¿Ð¾Ñ‡Ñ‚Ðµ",
		"Chime" : "Ð—Ð²Ð¾Ð½Ð¾Ðº",
		"Exit chat" : "Ð’Ñ‹Ñ…Ð¾Ð´ Ð¸Ð· Ñ‡Ð°Ñ‚Ð°",
		"Text to speech" : "Ð¢ÐµÐºÑÑ‚ Ð² Ñ€ÐµÑ‡ÑŒ",
		"Speech Recognition" : "Ð Ð°ÑÐ¿Ð¾Ð·Ð½Ð°Ð²Ð°Ð½Ð¸Ðµ Ñ€ÐµÑ‡Ð¸",
		"Quit private channel" : "Ð’Ñ‹Ð¹Ñ‚Ð¸ Ð¸Ð· Ñ‡Ð°ÑÑ‚Ð½Ð¾Ð³Ð¾ ÐºÐ°Ð½Ð°Ð»Ð°",
		"Quit private or channel": "Ð’Ñ‹Ð¹Ñ‚Ð¸ Ð¸Ð· Ñ‡Ð°ÑÑ‚Ð½Ð¾Ð³Ð¾ ÐºÐ°Ð½Ð°Ð»Ð°",
		"Would you like a copy of the chat log sent to your email?" : "OÑ‚Ð¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ ÐºÐ¾Ð¿ÑŽ Ð¶ÑƒÑ€Ð½Ð°Ð»Ð° Ñ‡Ð°Ñ‚Ð° Ð½Ð° Ð²Ð°Ñˆ Ð°Ð´Ñ€ÐµÑ ÑÐ»ÐµÐºÑ‚Ñ€Ð¾Ð½Ð½Ð¾Ð¹ Ð¿Ð¾Ñ‡Ñ‚Ñ‹?"
	}
}
...
function WebLiveChatListener() {
	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				...
				+ "." + this.prefix + "scroller { overflow-x:hidden;height:420px;width:360px; }\n"
	...
	this.minimizeBox = function() {
		...
		if (this.promptEmailChatLog) {
			document.getElementById(this.prefix + "emailchatlogemail").value = this.contactEmail;
			document.getElementById(this.prefix + "emailchatlogdialog").style.display = 'inline';
			return false;
		}
...
function WebChatbotListener() {
	...
	this.createBox = function() {
		...
		var boxloc = "bottom:10px;right:22px";
		if (this.boxLocation == "top-left") {
			boxloc = "top:10px;left:10px";
		} else if (this.boxLocation == "top-right") {
			boxloc = "top:10px;right:22px";
		} else if (this.boxLocation == "bottom-left") {
			boxloc = "bottom:10px;left:10px";
		} else if (this.boxLocation == "bottom-right") {
			boxloc = "bottom:10px;right:22px";
		}
		var locationBottom = 20;
		...
		var html =
			"<style>\n"
				+ "." + this.prefix + "box { position:fixed;" + boxloc + ";z-index:1502;margin:2px;display:none;border:0px; box-shadow: 1px 5px 19px #808080;	-webkit-border-top-left-radius: 10px;-webkit-border-top-right-radius: 10px;-moz-border-radius-topleft: 10px;-moz-border-radius-topright: 10px;border-top-left-radius: 10px;border-top-right-radius: 10px;}\n"
				+ "." + this.prefix + "boxmenu { visibility:" + hidden + "; }\n"
				+ (this.forceStyles ? "#" : ".") + "" + this.prefix + "boxbarmax { font-size:18px;margin:2px;padding:0px;text-decoration:none; }\n"
				+ "." + this.prefix + "boxbar { position:fixed;" + boxbarloc + ";z-index:152;margin:0;padding:6px;" + buttonstyle + " }\n"
				+ "." + this.prefix + "boxbar:hover { " + buttonHoverStyle + " }\n"
		...
		html = html + this.style
			...
			+ "<div id='" + this.prefix + "box' class='" + this.prefix + "box' " + backgroundstyle + ">"
				+ "<div class='" + this.prefix + "boxmenu'>"
				+'<span style="float:left;padding-right: 150px;" class="botplatformuser-bot"><img src="https://i.imgur.com/nylTDuF.png" alt="Smiley face" width="110" height="20"></span><span style="" class="botplatformuser-bot"><a "botplatformspeechbutton"="" onclick="return false;" href="#" title="Speech"><img id="botplatformboxspeak" class="botplatformboxbutton" src="https://i.imgur.com/quJkEWx.png"></a></span><span style="" class="botplatformuser-bot"><a id="botplatformspeechRecognitionButton" onclick="return false;" href="#" title="Speech Recognition"><img id="botplatformboxspeakrecognition" class="botplatformboxbutton" src="https://i.imgur.com/IvZdiKX.png"></a></span>' 
					+ (this.backlink ? "<span class='" + this.prefix + "chatpowered'>powered by <a href='" + SDK.backlinkURL + "' target='_blank'>" + SDK.NAME + "</a></span>" : "")
					+ "<span style='float:right;  padding-top:5px; padding-right:4px;'><a id='" + this.prefix + "boxmin' class='" + this.prefix + "boxmin' onclick='return false;' href='#'><img src='https://i.imgur.com/58zLTRm.png?1'></a> ";
		if (this.showBoxmax) {
			//html = html + "<a id='" + this.prefix + "boxmax' class='" + this.prefix + "boxmax' onclick='return false;' href='#'><img src='" + SDK.url + "/images/open.png'> </a></span><br/>";
		} else {
			html = html + "</span><br/>";
		...
		if (this.showMenubar) {
			html = html
				+ "<div id='" + this.prefix + "menudiv' class='" + this.prefix + "menudiv' style='display:none'>"
			...
			html = html
				...
				if (this.showChooseLanguage) {
					//html = html + "<img id='" + this.prefix + "boxlanguage2' class='" + this.prefix + "boxbutton' src='" + urlprefix + "/images/language.svg'>";
				}
				html = html + "</span>";
			if (this.allowSpeech) {
				html = html
			...
			if (this.allowSpeechRecognition == true || (this.allowSpeechRecognition == null && this.allowSpeech && SDK.isChrome())) {
				html = html
					+ "<a id='" + this.prefix + "speechRecognitionButton' onclick='return false;' href='#' title='Speech Recognition'><img id='" + this.prefix + "boxspeakrecognition' class='" + this.prefix + "boxbutton' src='https://i.imgur.com/An29tFE.png'></a>";
			}
		...
		if (this.promptContactInfo) {
			html = html
				+ "<div id='" + this.prefix + "contactinfo' class='" + this.prefix + "box' " + backgroundstyle + ">"
					+ "<div class='" + this.prefix + "boxmenu'>"
						+ "<span style='float:right; padding-top:5px; padding-right:4px;'><a id='" + this.prefix + "contactboxmin' class='" + this.prefix + "contactboxmin' onclick='return false;' href='#'><img src='https://i.imgur.com/58zLTRm.png?1'></a>"
					+ "</div>\n"
					+ "<div style='margin:10px'>\n"
						+ "<span>" + SDK.translate("Name") + "</span><br/><input id='" + this.prefix + "contactname' type='text' /><br/>\n"
						+ "<span>" + SDK.translate("Email") + "</span><br/><input id='" + this.prefix + "contactemail' type='email' /><br/>\n"
		...
		if (document.getElementById(this.prefix + "boxspeak") != null) {
			document.getElementById(this.prefix + "boxspeak").addEventListener("click", function() {
				...
				if (self.speak) {
					SDK.initAudio();
					document.getElementById(self.prefix + "boxspeak").src = "https://i.imgur.com/quJkEWx.png";
					document.getElementById(self.prefix + "boxspeak2").src = "https://i.imgur.com/quJkEWx.png";
				} else {
					document.getElementById(self.prefix + "boxspeak").src = "https://i.imgur.com/4EFIAcI.png";
					document.getElementById(self.prefix + "boxspeak2").src = "https://i.imgur.com/4EFIAcI.png";
				}
				return false;
			});
		...
		if (document.getElementById(this.prefix + "boxspeakrecognition") != null) {
			...
			document.getElementById(this.prefix + "boxspeakrecognition").addEventListener("click", function() {
				...
				if (self.listen) {
					SDK.startSpeechRecognition();
					document.getElementById(self.prefix + 'boxspeakrecognition').src = "https://i.imgur.com/An29tFE.png";
					document.getElementById(self.prefix + 'boxspeakrecognition2').src = "https://i.imgur.com/An29tFE.png";
				} else {
					SDK.stopSpeechRecognition();
					document.getElementById(self.prefix + 'boxspeakrecognition').src = "https://i.imgur.com/IvZdiKX.png";
					document.getElementById(self.prefix + 'boxspeakrecognition2').src = "https://i.imgur.com/IvZdiKX.png";
				}
			});
...
function WebAvatar() {
	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				+ "." + this.prefix + "avatarbox { position:fixed;bottom:10px;left:10px;z-index:152;margin:2px;" + border + divWidth + " }\n"
...
function SDKConnection() {
	 ...
	 */
	this.poolUserToUserMessages = function(config, processor) {
		config.addCredentials(this);
...
function ResponseConfig() {
	...
	this.parseXML = function(element) {
		...
		this.responseMetaId = element.getAttribute("responseMetaId");
	...
	this.toXML = function() {
		...
		if (this.responseMetaId != null) {
			xml = xml + (" responseMetaId=\"" + this.responseMetaId + "\"");
		}
		if (this.label) {
			xml = xml + (" label=\"" + this.label + "\"");
		}
		if (this.topic) {
			xml = xml + (" topic=\"" + this.topic + "\"");
		}
		if (this.keywords) {
			xml = xml + (" keywords=\"" + this.keywords + "\"");
		}
		if (this.required) {
		...
		if (this.sentiment) {
			xml = xml + (" sentiment=\"" + this.sentiment + "\"");
		}
